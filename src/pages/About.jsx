...
const About = () => {
  ...
  return (
    <div className="relative bg-[#2e2e2e] min-h-screen ">
      <ClientNavbar />
      <section className="bg-[#222222] text-white py-32 pt-32  min-h-screen">
        <motion.div
          ref={ref}
          initial="hidden"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Welcome to SA BLOGS, where coding meets creativity! Our mission
                is to provide a comprehensive resource for developers of all
                skill levels. We offer in-depth tutorials, insightful articles,
                and the latest trends in web development to help you enhance
                your skills and navigate the ever-evolving tech landscape.
              </motion.p>
              <motion.a
                variants={fadeInUpAnimation}
                href="#_"
            ...
            <motion.div
              variants={fadeInUpAnimation}
              className="img w-[80%] mx-auto md:w-[40%] lg:w-[50%] pb-6"
            >
              <img
                src="/images/logo.svg"
                className="rounded-full w-[80%] sm:w-[50%] mx-auto lg:w-[70%]"
                alt="IMG_NOT_FOUND"
              />
            </motion.div>
          </motion.div>
